module.exports = function (app, service) {
	...
	var DirectMessage = service.useModel('DirectMessage');
	
	/**
	 * POST /game/directmessage/
	 * creates new direct message and returns the id.
	 */
	app.post('/test/directmessage/', function(req, res) {
		//get obj
	 ...
	 */
	app.get('/test/directmessage/:id', function(req, res) {
		if (req.params.id === {})
		{
	 ...
	 */
	app.delete('/test/directmessage/:id', function(req, res) {
		if (req.params.id === {})
		{
			res.send(400, "Must include id.");
		}
